...
const SearchedPostView = ({loading}) => {
  ...
  const posts = useSelector((state) => state.searchReducer.searchedPosts);
  return (
    <>{
    loading ? (<div className="mt-10"><SpinnerComponent/></div>) : (
    <div className="overflow-auto h-[30rem] w-full">
      {posts && (
        <>
          <ResponsiveMasonry
